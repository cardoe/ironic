...
output "network_ids" {
  ...
  value = {
    ...
    trunk = openstack_networking_network_v2.trunk.id
...
output "switch_mgmt_mac" {
  description = "MAC address of the switch mgmt0 port"
  value       = openstack_networking_port_v2.switch_mgmt.mac_address
}
